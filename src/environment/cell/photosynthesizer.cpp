...
auto Photosynthesizer::tick(i32 x, i32 y, Organism & organism, Environment & environment, OrganismGrid & organismGrid, Settings & settings, std::default_random_engine & random) -> void {
