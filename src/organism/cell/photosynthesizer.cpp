...
export module Photosynthesizer;
...
namespace Photosynthesizer {
	export auto tick(i32 x, i32 y, Organism & organism, Environment & environment, OrganismGrid & organismGrid, Settings & settings, std::vector<Organism> & organisms, std::default_random_engine & random) -> void {
